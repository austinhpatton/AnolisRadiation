...
# Run the model
bisse <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = F, turnover.anc = c(1,2,0,0),
               eps.anc = c(1,2,0,0), trans.rate = trans.rates.bisse, output.type = "raw")

# Get support region by sampling likelihood surface
recon_bisse <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=bisse$solution, hidden.states = F, aic=bisse$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
#################################################################
bisse.null.uneq <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = F, turnover.anc = c(1,1,0,0),
                         eps.anc = c(1,1,0,0), trans.rate = trans.rates.bisse, output.type = "raw")

recon_bisse.null.uneq <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=bisse.null.uneq$solution, hidden.states = F, aic=bisse.null.uneq$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
bisse.null.eq <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = F, turnover.anc = c(1,1,0,0),
                       eps.anc = c(1,1,0,0), trans.rate = trans.rate, output.type = "raw")

recon_bisse.null.eq <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=bisse.null.eq$solution, hidden.states = F, aic=bisse.null.eq$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
hisse.full_AllTrans <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,2,3,4),
...
hisse.full_NoDub <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,2,3,4),
                          eps.anc = c(1,2,3,4), trans.rate = trans.rates.hisse, output.type = "raw")

recon_hisse.full_NoDub <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=hisse.full_NoDub$solution, hidden.states = T, aic=hisse.full_NoDub$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
Null2_AllTrans_Eq <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,1,2,2),
                           eps.anc = c(1,1,2,2), trans.rate = trans.rate, output.type = "raw")

recon_Null2_AllTrans_Eq <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=Null2_AllTrans_Eq$solution, hidden.states = T, aic=Null2_AllTrans_Eq$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
Null2_NoDub_Eq <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,1,2,2),
                        eps.anc = c(1,1,2,2), trans.rate = trans.rate, output.type = "raw")

recon_Null2_NoDub_Eq <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=Null2_NoDub_Eq$solution, hidden.states = T, aic=Null2_NoDub_Eq$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
Null2_ThreeRate_NoDub <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,1,2,2),
                               eps.anc = c(1,1,2,2), trans.rate = trans.rate, output.type = "raw")

recon_Null2_ThreeRate_NoDub <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=Null2_ThreeRate_NoDub$solution, hidden.states = T, aic=Null2_ThreeRate_NoDub$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
###################################
hisse.null4.equal <- hisse.null4(phy = tree, data = dat, f = c(0.82, 0.85),  turnover.anc = rep(c(1,2,3,4),2),
                                 eps.anc = rep(c(1,2,3,4),2), trans.type = "equal", output.type = "raw")

recon_hisse.null4.equal <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=hisse.null4.equal$solution, hidden.states = T, aic=hisse.null4.equal$AICc, n.cores = 10, four.state.null = T, root.p = c(0.5, 0, 0.5, 0))
...
###################################
hisse.null4.three <- hisse.null4(phy = tree, data = dat, f = c(0.82, 0.85),  turnover.anc = rep(c(1,2,3,4),2),
                                 eps.anc = rep(c(1,2,3,4),2), trans.type = "three.rate", output.type = "raw")

recon_hisse.null4.three <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=hisse.null4.three$solution, hidden.states = T, aic=hisse.null4.three$AICc, n.cores = 10, four.state.null = T, root.p = c(0.5, 0, 0.5, 0))
...
no0B_AllTrans <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,2,0,3),
                       eps.anc = c(1,2,0,3), trans.rate = trans.rates.hisse, output.type = "raw")

recon_no0B_AllTrans <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=no0B_AllTrans$solution, hidden.states = T, aic=no0B_AllTrans$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
no0B_NoDub <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,2,0,3),
                    eps.anc = c(1,2,0,3), trans.rate = trans.rates.hisse, output.type = "raw")

recon_no0B_NoDub <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=no0B_NoDub$solution, hidden.states = T, aic=no0B_NoDub$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
no1B_AllTrans <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,2,3,0),
                       eps.anc = c(1,2,3,0), trans.rate = trans.rates.hisse, output.type = "raw")

recon_no1B_AllTrans <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=no1B_AllTrans$solution, hidden.states = T, aic=no1B_AllTrans$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
no1B_NoDub <- hisse(phy = tree, data = dat, f = c(0.82, 0.85), hidden.states = T, turnover.anc = c(1,2,3,0),
                    eps.anc = c(1,2,3,0), trans.rate = trans.rates.hisse, output.type = "raw")

recon_no1B_NoDub <- MarginRecon(tree, dat, f = c(0.82, 0.85), pars=no1B_NoDub$solution, hidden.states = T, aic=no1B_NoDub$AICc, n.cores = 10, root.p = c(0.5, 0, 0.5, 0))
...
write.csv(results, 'ModelSupport_HiSSE.csv')
...
pdf('ModAvg_RateTree_NetDiv.pdf', height = 7, width=8)
...
pdf('ModAvg_RateTree_NetDiv-ForFig.pdf', height = 10, width=7)
plot(hisse.contMap$rate.tree, outline = F, lwd = 3)
dev.off()

pdf('AncStateRecon-BestFitHisse.pdf', width = 8, height = 18)
